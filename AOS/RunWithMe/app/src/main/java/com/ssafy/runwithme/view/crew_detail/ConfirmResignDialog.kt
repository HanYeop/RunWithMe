...
import com.ssafy.runwithme.databinding.DialogConfirmResignBinding
...
class ConfirmResignDialog (context: Context, private val text : String, private val listener : ConfirmResignListener): Dialog(context) {

    private lateinit var binding: DialogConfirmResignBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.inflate(
            ...
            R.layout.dialog_confirm_resign,
            null,
            false
        )
